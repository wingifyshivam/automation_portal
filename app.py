...
AUTOMATIONS = {
    ...
    "Manually Remove Pink Slots": {
        "script": "scripts/pink_slot_removal.py",
        "template": "pink_slot_removal_params.html",
        "params": ["diary_date", "modified_by_function"]
    },
    "Newmedica Worklists": {
        "script": "scripts/worklists.py",
        "template": "worklists_params.html",
        "params": ["client", "dashboard_set", "dashboard_workflow", "dashboard_view"]
    }
}
